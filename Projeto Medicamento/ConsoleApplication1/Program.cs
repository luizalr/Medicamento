...
namespace ConsoleApplication1
{
    class Program
    {
      ...
      //  static Lote minhaListaLote = new Lote();
      ...
      //  static Medicamento medicParc;
        ...
        //Lote minhaListaLote;
        //Medicamento minhaListaMedicamento;
        //Medicamentos minhaListaMedicamentos;
        //Lote lotParc;
        //Medicamento medicParc;
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                else if (op == 4)
                {
                    ...
                    DateTime venc = System.DateTime.Now;//DateTime.MaxValue
